...
test('get activities property filters by model type', function () {
    ActivityLog::factory()->create(['model_type' => 'App\\Models\\Orders\\Order']);
    ActivityLog::factory()->create(['model_type' => 'App\\Models\\Inventory\\Product']);

    test()->page->filterModelType = 'App\\Models\\Orders\\Order';
    $result = test()->page->getActivitiesProperty();
