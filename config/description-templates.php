...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Sentence templates keyed by tone. Placeholders ({product}, {category},
    | {adjective}, {price}) are substituted by DescriptionGeneratorService.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Adjective pools keyed by product category (singular and plural forms are
    | both accepted so the lookup survives either way).
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Used when the product category is unknown or has no category-specific
    | adjective pool.
    |
    */

    'default_adjectives' => ['fresh', 'handcrafted', 'artisan', 'delicious', 'premium'],

    /*
    |--------------------------------------------------------------------------
    | Long Description Extras
    |--------------------------------------------------------------------------
    |
    | Supplementary sentences appended when a "long" description is requested.
    |
    */
