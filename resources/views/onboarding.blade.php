...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card { background: white; border-radius: 1.5rem; padding: 3rem; max-width: 500px; width: 100%; box-shadow: 0 8px 30px rgba(0,0,0,0.08); margin: 2rem; }
        ...
        input { width: 100%; padding: 0.75rem 1rem; border: 2px solid #f0e6d2; border-radius: 0.75rem; font-size: 1rem; font-family: inherit; transition: border-color 0.2s; margin-bottom: 0.5rem; }
