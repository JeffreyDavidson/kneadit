    ...
    <x-central.card>
        ...
        @if (empty($items))
            <div class="flex items-center gap-3 py-3">
                ...
                <div>
                    <div class="text-white font-semibold text-[0.9rem]">All clear</div>
            ...
            <div class="space-y-2">
                @foreach ($items as $item)
                    ...
                    <a href="{{ $item['url'] }}"
                        ...
                        <span class="hidden sm:inline-flex items-center gap-1 text-[0.75rem] font-semibold text-honey shrink-0">
                            {{ $item['cta'] }}
