    ...
    <div class="max-w-[900px] mx-auto">
        ...
        <div class="grid grid-cols-2 gap-6 items-start">
            ...
            <div class="bg-[#FFF8E1] border border-[#D7CCC8] rounded-xl p-6">
                <h3 class="m-0 mb-4 text-[#3E2723] text-[1.1rem] font-semibold flex items-center gap-2">
            ...
            <div class="bg-white border border-[#D7CCC8] rounded-xl p-6 text-center">
                <h3 class="m-0 mb-4 text-[#3E2723] text-[1.1rem] font-semibold flex items-center justify-center gap-2">
