<x-filament-panels::page>
    <div class="max-w-4xl space-y-10">
        ...
        <section class="space-y-3">
            ...
            <p>
                Webhooks let KneadIt push order events to a URL of your choice in real time — no polling, no scheduled
                syncs. When an order is created, updated, cancelled, or delivered, we POST a JSON body to the webhook
                URL configured under <strong>Settings → Integrations</strong>. Use them to wire orders into Zapier,
                QuickBooks, your CRM, a custom dashboard, or anything that can accept an HTTP request.
            </p>
        </section>
  ...
  "delivered_at": "2026-05-04T15:32:00+00:00"
        ...
        <section class="space-y-4">
            ...
            <p>
                Compute HMAC-SHA256 over the raw request body using your secret. Compare your computed value to the
                <code>X-KneadIt-Signature</code> header.
            </p>
...
if not hmac.compare_digest(expected, received):
    abort(401)</code></pre>
        ...
        <section class="space-y-3">
            ...
            <p>
                If your endpoint returns a non-2xx status or the connection fails, we retry up to
                <strong>2 additional times</strong> with a 100ms backoff, then give up. Every attempt is recorded in
                <strong>Operations → Webhook Deliveries</strong>, including the response body (truncated to 2KB) and any
                error message.
            </p>
            <p>
                You can manually re-fire any past delivery using the <strong>Redeliver</strong> action on the deliveries
                page.
            </p>
        </section>
        ...
        <section class="space-y-3">
            ...
            <ul class="list-inside list-disc space-y-1">
                ...
                <li>
                    ...
                    <strong>Settings → Integrations → Regenerate</strong>.
                </li>
            </ul>
        </section>
    </div>
