<x-filament-panels::page>
    <div class="space-y-4">
        <p class="text-sm text-gray-500 dark:text-gray-400">
            Customize the subject line and body content of emails sent to your customers. Use placeholders like <code class="text-primary-600 dark:text-primary-400">{customer_name}</code> to insert dynamic values.
        </p>
            ...
            <div class="fi-section rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
                <div class="flex items-center justify-between p-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <x-filament::button
                            size="sm"
                            wire:click="editTemplate('{{ $template['type'] }}')"
                        >
                            Edit
                        </x-filament::button>
                    </div>
