<x-filament-panels::page>
    <style @cspnonce>
        ...
        .config-shell-title {
            font-size: 0.65rem; font-weight: 600; color: var(--brand-300);
            text-transform: uppercase; letter-spacing: 0.1em; margin: 0;
        }
        .config-shell-hint {
            font-size: 0.7rem; color: var(--brand-400);
        }
        ...
        .preview-widget-header span { color: var(--brand-100); font-size: 0.75rem; font-weight: 600; }
        ...
        .config-tile.sortable-drag { box-shadow: 0 8px 24px rgba(0, 0, 0, 0.4); z-index: 20; opacity: 1; }
        ...
        .config-ctrl {
            ...
            border-radius: 6px; border: 1px solid color-mix(in srgb, var(--brand-700) 60%, transparent);
            cursor: pointer;
        ...
        .config-ctrl:hover { background: var(--brand-800); color: var(--brand-300); border-color: color-mix(in srgb, var(--brand-300) 40%, transparent); }
        .config-drag { cursor: grab; }
        .config-toggle.is-on { color: var(--brand-300); }
        .config-toggle.is-off { color: #f87171; background: rgba(248, 113, 113, 0.1); border-color: rgba(248, 113, 113, 0.25); }
        ...
        .config-size-btn {
            ...
            background: color-mix(in srgb, var(--brand-900) 90%, transparent);
            color: var(--brand-400); font-size: 0.65rem; font-weight: 700;
            transition: background 0.15s, color 0.15s;
        }
        .config-size-btn:hover { background: var(--brand-800); color: var(--brand-200); }
        .config-size-btn.active { background: var(--brand-300); color: var(--brand-900); }
        ...
        .pw-stat-value { font-size: 1.4rem; font-weight: 700; color: #fff; }
        .pw-stat-label { font-size: 0.65rem; color: var(--brand-400); text-transform: uppercase; letter-spacing: 0.05em; }
        .pw-bar { height: 6px; border-radius: 3px; background: color-mix(in srgb, var(--brand-700) 40%, transparent); margin-top: 6px; }
        .pw-bar-fill { height: 100%; border-radius: 3px; background: var(--brand-300); }
        .pw-line { height: 40px; display: flex; align-items: end; gap: 2px; }
        .pw-line-bar { flex: 1; background: color-mix(in srgb, var(--brand-300) 50%, transparent); border-radius: 2px 2px 0 0; min-height: 4px; }
        .pw-row { display: flex; justify-content: space-between; padding: 4px 0; border-bottom: 1px solid color-mix(in srgb, var(--brand-700) 30%, transparent); font-size: 0.7rem; color: var(--brand-100); }
        ...
        .config-footer a {
            font-size: 0.9rem; color: var(--brand-300); text-decoration: none;
            display: flex; align-items: center; gap: 6px;
        }
        .config-footer a:hover { color: var(--brand-200); }
    </style>
