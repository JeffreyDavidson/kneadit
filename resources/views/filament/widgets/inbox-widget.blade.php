...
<div>
    @if ($count > 0)
        <x-tenant-admin.dashboard.preview-card heading="Inbox" icon="heroicon-o-inbox-arrow-down">
            <a href="{{ $this->getMessagesUrl() }}" style="text-decoration: none; color: inherit; display: block">
                <x-tenant-admin.dashboard.stat-row label="Unread messages" :value="$count" />
