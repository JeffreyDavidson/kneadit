...
<x-tenant-admin.dashboard.preview-card heading="Customer Reviews" icon="heroicon-o-star">
            ...
            <div style="flex: 1">
                @foreach ($dist as $stars => $data)
                    <div style="display: flex; align-items: center; gap: 6px; margin-bottom: 3px">
                        ...
                        <div style="flex: 1" class="pw-bar">
                            <div class="pw-bar-fill" style="width: {{ $data['percentage'] }}%;"></div>
                        </div>
    ...
    @unless ($this->isSize('sm'))
        @if ($recent)
            <div
                style="
                    ...
                    border-left: 3px solid var(--pw-card-accent);
                    border-radius: 6px;
                "
            >
        ...
        @else
            <div style="margin-top: 8px; font-size: 0.7rem; color: var(--pw-card-text-muted); font-style: italic">
                No reviews yet
            </div>
        @endif
    @endunless
