...
<x-tenant-admin.dashboard.preview-card heading="Loyalty Leaders" icon="heroicon-o-trophy">
    <x-tenant-admin.dashboard.stat-row
    ...
    @if ($showAwards && count($recentAwards) > 0)
        ...
        @foreach ($recentAwards as $award)
            <x-tenant-admin.dashboard.list-row :value="$award['date']">
