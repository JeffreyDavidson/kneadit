    ...
    <div class="auth-card">
        ...
        <form method="POST" action="/register">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="{{ __('forms.placeholders.name') }}" required autofocus>
                @error('name') <div class="form-error">{{ $message }}</div> @enderror
            </div>

            <div class="form-group">
                <label for="email">{{ __('forms.labels.email') }}</label>
                <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="{{ __('forms.placeholders.email') }}" required>
                @error('email') <div class="form-error">{{ $message }}</div> @enderror
            </div>

            <div class="form-group">
                <label for="bakery_name">{{ __('auth.register.bakery_name') }}</label>
                <input type="text" id="bakery_name" name="bakery_name" value="{{ old('bakery_name') }}" placeholder="{{ __('auth.register.bakery_name_placeholder') }}" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" placeholder="{{ __('forms.placeholders.min_characters') }}" required>
                    @error('password') <div class="form-error">{{ $message }}</div> @enderror
                </div>
                <div class="form-group">
                    <label for="password_confirmation">{{ __('forms.labels.confirm_password') }}</label>
                    <input type="password" id="password_confirmation" name="password_confirmation" placeholder="{{ __('forms.placeholders.confirm') }}" required>
                </div>
            </div>
        ...
        <div class="auth-footer">
            ...
            <a href="/forgot-password" style="margin-top:.5rem;display:inline-block">{{ __('auth.register.forgot_password') }}</a>
        </div>
    </div>
</div>
</body>
