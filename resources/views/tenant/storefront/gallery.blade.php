<x-layouts.storefront>
    ...
    @if ($storefrontTheme === 'biscotto')
        @include('tenant.storefront.themes.biscotto.gallery')
    @else
        {{-- Photo-Forward Hero --}}
            ...
            >
                ...
                <div class="w-full max-w-4xl" @click.stop>
                    ...
                    <div class="mt-4 text-center" x-show="caption || author">
                        <p
                            x-show="caption"
                            class="text-warm-300 text-lg italic"
                            x-text="'&quot;' + caption + '&quot;'"
                        ></p>
            ...
            <div class="mx-auto max-w-2xl px-4">
                ...
                <div class="bg-warm-800 border-warm-700/20 rounded-2xl border p-8 md:p-10">
                    ...
                    >
                        ...
                        <div x-data="{ fileName: '' }">
                            <label class="text-warm-300 mb-2 block text-sm font-medium"
                                >Photo *
                                <span class="text-warm-500 font-normal">(JPG, PNG, or WebP — max 5MB)</span></label>
