...
<div style="text-align: center; margin: 25px 0;">
    <a href="{{ route('order.create') }}" style="display: inline-block; background-color: {{ $primaryColor }}; color: #ffffff; padding: 14px 30px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px;">
        Order Now
    </a>
</div>
@endsection
