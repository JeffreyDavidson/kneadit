...
<section class="py-16 px-4" style="background: var(--warm-200);">
    <div class="max-w-3xl mx-auto text-center">
        <p class="font-script text-xl mb-6" style="color: var(--warm-600);">Follow {{ $storeName }}</p>
        <div class="flex justify-center gap-4">
            @if (!empty($socialLinks['facebook']))
            <a href="{{ $socialLinks['facebook'] }}" target="_blank" rel="noopener"
               class="w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg"
               style="background: var(--warm-900); color: var(--warm-400);"
               onmouseover="this.style.background='var(--warm-500)';this.style.color='var(--warm-900)'"
               onmouseout="this.style.background='var(--warm-900)';this.style.color='var(--warm-400)'">
            ...
            <a href="{{ $socialLinks['tiktok'] }}" target="_blank" rel="noopener"
               class="w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg"
               style="background: var(--warm-900); color: var(--warm-400);"
               onmouseover="this.style.background='var(--warm-500)';this.style.color='var(--warm-900)'"
               onmouseout="this.style.background='var(--warm-900)';this.style.color='var(--warm-400)'">
