...
--}}
<div
    class="relative w-full h-full overflow-hidden font-display"
...
>
    ...
    @if ($eyebrow !== '')
        ...
        >
            <span
                style="display: inline-block; flex-shrink: 0; width: 1.5rem; height: 1px; background: currentColor; opacity: 0.65;"
            ></span>
            <span
                class="font-body uppercase font-semibold truncate"
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center" aria-hidden="true">
        ...
        <span
            ...
            style="margin-top: 1.25rem; gap: 0.625rem;"
        >
