...
<style>
    ...
    .contact-fade-1 { animation: contactFadeUp 0.7s ease-out 0.2s both; }
    .contact-fade-2 { animation: contactFadeUp 0.7s ease-out 0.4s both; }
</style>
...
<section class="relative overflow-hidden" style="background: var(--warm-900); min-height: 45vh;">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center text-center px-4" style="min-height: 45vh; padding-top: 8vh;">
        ...
        <h1 class="contact-fade-1 font-display text-5xl md:text-7xl lg:text-8xl font-bold leading-none mb-6" style="color: var(--warm-100);">
            We'd Love to<br>Hear From You
        </h1>
        <p class="contact-fade-2 text-lg md:text-xl max-w-xl mx-auto" style="color: var(--warm-400);">
