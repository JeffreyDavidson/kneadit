...
<section class="relative overflow-hidden" style="min-height: 55vh;">
    <div class="absolute inset-0">
        <img src="{{ $settings->heroImageUrl() }}" alt="{{ $settings->storeName }} contact" class="w-full h-full object-cover contact-hero-img">
    </div>
    ...
    <div class="max-w-5xl mx-auto px-4 py-10">
        <div class="grid sm:grid-cols-3 gap-4">
            ...
            <div class="info-card p-6 rounded-2xl text-center" style="background: rgba(139,104,68,0.1); border: 1px solid rgba(139,104,68,0.15);">
                ...
                <p class="text-sm" style="color: var(--warm-300);">{{ $settings->storeAddress }}</p>
            </div>
            @endif
            ...
            <div class="info-card p-6 rounded-2xl text-center" style="background: rgba(139,104,68,0.1); border: 1px solid rgba(139,104,68,0.15);">
                ...
                <p class="text-sm"><a href="tel:{{ $settings->storePhone }}" style="color: var(--warm-300);">{{ $settings->storePhone }}</a></p>
            </div>
            @endif
            ...
            <div class="info-card p-6 rounded-2xl text-center" style="background: rgba(139,104,68,0.1); border: 1px solid rgba(139,104,68,0.15);">
                ...
                <p class="text-sm"><a href="mailto:{{ $settings->storeEmail }}" style="color: var(--warm-300);">{{ $settings->storeEmail }}</a></p>
            </div>
            @endif
        </div>
    </div>
        ...
        <div class="grid md:grid-cols-5 gap-12 md:gap-16">
            ...
            <div class="md:col-span-2 space-y-8">
                ...
                <div class="rounded-2xl overflow-hidden" style="aspect-ratio: 16/10; background: var(--warm-200);">
                    <div class="w-full h-full flex items-center justify-center">
                        <div class="text-center px-6">
                            ...
                            <p class="text-sm font-medium" style="color: var(--warm-500);">{{ $settings->storeAddress }}</p>
                        </div>
                    </div>
                </div>
                @endif
                ...
                <div class="p-6 rounded-2xl" style="background: var(--warm-200); border-left: 3px solid var(--warm-500);">
                    ...
                    <p class="text-sm leading-relaxed" style="color: var(--warm-600);">{{ $settings->allergyDisclaimer }}</p>
                </div>
                @endif
            </div>
        </div>
