...
<head>
    ...
    <meta
        name="description"
        content="Orders, invoicing, recipes, finances, storefronts — built specifically for home bakers who sell. Stop managing chaos, start baking."
    />
...
<body>
            ...
            <h1 class="hero-headline reveal reveal-d1">
                ...
                <span class="hero-headline-input-wrap">
                    <input
                        ...
                        autocomplete="off"
                        spellcheck="false"
                        placeholder="Type your bakery name..."
                    />
                </span>
            </h1>
            ...
            <div class="storefront-preview reveal reveal-d2" id="storefrontPreview">
                ...
                <div class="sf-products">
                    <div class="sf-product">
                        <div class="sf-product-img"></div>
                        <div class="sf-product-name">Sourdough Loaf</div>
                        <div class="sf-product-price">$8</div>
                    </div>
                    <div class="sf-product">
                        <div class="sf-product-img"></div>
                        <div class="sf-product-name">Cinnamon Rolls (6)</div>
                        <div class="sf-product-price">$18</div>
                    </div>
                    <div class="sf-product">
                        <div class="sf-product-img"></div>
                        <div class="sf-product-name">Focaccia</div>
                        <div class="sf-product-price">$12</div>
                    </div>
                </div>
    ...
    <section class="bakers-day" id="bakersDay">
        <div class="bakers-day-intro">
            ...
            <p class="reveal reveal-d1">
                From the first light check to your evening profit smile, here's how KneadIt turns a busy day into a
                smooth one.
            </p>
        ...
        <div class="day-timeline">
            <div class="day-entry">
                <div class="day-card">
                    ...
                    <div class="day-ui">
                        <div class="day-ui-row">
                            <span>Emma — Sourdough (2)</span
                            ><span style="font-size: var(--text-xs); color: var(--sage)">8:00 AM</span>
                        </div>
                        <div class="day-ui-row">
                            <span>Marcus — Cinnamon Rolls</span
                            ><span style="font-size: var(--text-xs); color: var(--sage)">9:30 AM</span>
                        </div>
                        <div class="day-ui-row">
                            <span>Priya — Focaccia + Loaf</span
                            ><span style="font-size: var(--text-xs); color: var(--sage)">10:00 AM</span>
                        </div>
                        <div class="day-ui-row">
                            <span>Jake — Birthday Cake</span
                            ><span style="font-size: var(--text-xs); color: var(--sage)">12:00 PM</span>
                        </div>
                        <div class="day-ui-row">
                            <span>Sarah — Dinner Rolls (24)</span
                            ><span style="font-size: var(--text-xs); color: var(--sage)">2:00 PM</span>
                        </div>
                        <div class="day-ui-row">
                            <span>Liu — Bagels (12)</span
                            ><span style="font-size: var(--text-xs); color: var(--sage)">3:30 PM</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="day-entry">
                <div class="day-card">
                    ...
                    <div class="day-ui">
                        ...
                        <div class="day-ui-row">
                            <span>Emma's Sourdough</span
                            ><span class="day-ui-pill pill-baking" style="font-size: 10px">Baking</span>
                        </div>
                        <div class="day-ui-row">
                            <span>Marcus's Cinnamon Rolls</span
                            ><span class="day-ui-pill pill-baking" style="font-size: 10px">Baking</span>
                        </div>
                        <div class="day-ui-row">
                            <span>Priya's Focaccia</span
                            ><span class="day-ui-pill pill-confirmed" style="font-size: 10px">Confirmed</span>
                        </div>
                    </div>
                </div>
                <div class="day-spacer"></div>
            ...
            <div class="day-entry">
                <div class="day-card">
                    ...
                    <div class="day-ui" style="text-align: center; padding: 1.5rem 1rem">
                        ...
                        <div style="font-weight: 700; color: var(--warm-black); margin-bottom: 0.25rem">
                            Payment received
                        </div>
                        <div class="day-ui-badge badge-paid">✓ $47.00 paid</div>
                        <div style="margin-top: 0.75rem; font-size: var(--text-xs); color: var(--cinnamon)">
                            Invoice #1042 · Emma W.
                        </div>
                    </div>
                </div>
                ...
                <div class="day-card">
                    ...
                    <div class="day-ui" style="text-align: center; padding: 1.5rem 1rem">
                        ...
                        <div
                            ...
                            "
                        >
                            "Best sourdough I've ever had! The crust is perfection. Already ordering again."
                        </div>
                        <div style="margin-top: 0.5rem; font-weight: 600; font-size: var(--text-xs)">— Emma W.</div>
                    </div>
                </div>
                <div class="day-spacer"></div>
            ...
            <div class="day-entry">
                <div class="day-card">
                    ...
                    <div class="day-ui">
                        <div class="day-ui-profit" style="justify-content: center; padding: 0.5rem 0">
                            <div class="day-ui-stat">
                                <div class="day-ui-stat-val" style="color: var(--warm-black)">$312</div>
                                <div class="day-ui-stat-label">Revenue</div>
                            </div>
                            <div class="day-ui-stat">
                                <div class="day-ui-stat-val profit-red">$89</div>
                                <div class="day-ui-stat-label">Costs</div>
                            </div>
                            <div class="day-ui-stat">
                                <div class="day-ui-stat-val profit-green">$223 ↑</div>
                                <div class="day-ui-stat-label">Profit</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="numbers" id="numbers">
        <svg class="numbers-wheat numbers-wheat-l" width="60" height="180" viewBox="0 0 60 180" fill="none">
            <path d="M30 180 C30 180 30 20 30 5" stroke="#e8b04a" stroke-width="2" stroke-linecap="round" />
            <ellipse cx="18" cy="40" rx="8" ry="18" transform="rotate(-20 18 40)" fill="#e8b04a" />
            <ellipse cx="42" cy="55" rx="8" ry="18" transform="rotate(20 42 55)" fill="#e8b04a" />
            <ellipse cx="16" cy="80" rx="7" ry="16" transform="rotate(-25 16 80)" fill="#e8b04a" />
            <ellipse cx="44" cy="95" rx="7" ry="16" transform="rotate(25 44 95)" fill="#e8b04a" />
            <ellipse cx="20" cy="120" rx="6" ry="14" transform="rotate(-15 20 120)" fill="#e8b04a" />
            <ellipse cx="40" cy="135" rx="6" ry="14" transform="rotate(15 40 135)" fill="#e8b04a" />
        </svg>
        <svg class="numbers-wheat numbers-wheat-r" width="60" height="180" viewBox="0 0 60 180" fill="none">
            <path d="M30 180 C30 180 30 20 30 5" stroke="#e8b04a" stroke-width="2" stroke-linecap="round" />
            <ellipse cx="18" cy="40" rx="8" ry="18" transform="rotate(-20 18 40)" fill="#e8b04a" />
            <ellipse cx="42" cy="55" rx="8" ry="18" transform="rotate(20 42 55)" fill="#e8b04a" />
            <ellipse cx="16" cy="80" rx="7" ry="16" transform="rotate(-25 16 80)" fill="#e8b04a" />
        ...
        <div class="numbers-grid">
            <div class="number-item reveal">
                <div class="number-val" data-target="50" data-suffix="+">0</div>
                <div class="number-sub">features built for home bakers</div>
            </div>
            <div class="number-item reveal reveal-d1">
                <div class="number-val" data-target="100" data-suffix="%">0</div>
                <div class="number-sub">built &amp; tested in a real kitchen</div>
            </div>
            <div class="number-item reveal reveal-d2">
                <div class="number-val" data-target="0" data-prefix="$" data-suffix="">0</div>
                <div class="number-sub">to start · 30-day free trial</div>
            </div>
        </div>
    </section>
    ...
    <section class="features" id="features">
        <div class="features-header">
            ...
            <p class="reveal reveal-d1" style="color: var(--walnut); margin-top: 0.75rem; font-size: var(--text-lg)">
                Built by a baker who got tired of spreadsheets.
            </p>
        </div>
        <div class="bento">
            <!-- Large: Storefront -->
            <div class="bento-card bento-large reveal">
                ...
                <div class="bento-demo">
                    ...
                    <div class="bento-sf-grid">
                        <div class="bento-sf-item">
                            <div class="bento-sf-swatch"></div>
                            <div class="bento-sf-name">Sourdough</div>
                            <div class="bento-sf-price">$8</div>
                        </div>
                        <div class="bento-sf-item">
                            <div class="bento-sf-swatch"></div>
                            <div class="bento-sf-name">Cinnamon Rolls</div>
                            <div class="bento-sf-price">$18</div>
                        </div>
                        <div class="bento-sf-item">
                            <div class="bento-sf-swatch"></div>
                            <div class="bento-sf-name">Focaccia</div>
                            <div class="bento-sf-price">$12</div>
                        </div>
                    </div>
            ...
            <div class="bento-card bento-large reveal reveal-d1">
                ...
                <div class="bento-demo">
                    ...
                    <div style="font-size: var(--text-xs); color: var(--cinnamon); margin-top: 0.25rem">
                        Revenue cap: $180K / $250K
                    </div>
                </div>
            </div>
                ...
                <div class="bento-demo">
                    <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem">
                        <div style="text-align: center; flex: 1">
                            <div style="font-size: var(--text-xs); color: var(--cinnamon); margin-bottom: 0.25rem">
                                Cost per loaf
                            </div>
                            <div
                                style="
                            ...
                            <div style="font-size: var(--text-xs); color: var(--sage); font-weight: 700">
                                68% margin
                            </div>
                        </div>
                        ...
                        <div style="text-align: center; flex: 1">
                            ...
                            <div style="font-family: var(--font-serif); font-size: var(--text-xl); font-weight: 700">
                                $47.00
                            </div>
            ...
            <div class="bento-card bento-medium reveal reveal-d4">
                ...
                <div
                    class="bento-demo"
                    style="display: flex; align-items: center; justify-content: center; padding: 1.5rem"
                >
                    <div style="display: flex; flex-direction: column; gap: 0.75rem; width: 100%">
                        <div class="love-notif">
                            <span class="love-heart">♥</span
                            ><span style="font-size: var(--text-sm); font-weight: 500">Birthday discount sent!</span>
                        </div>
                        <div class="love-notif" style="animation-delay: 2s">
                            <span style="font-size: 1.25rem">🔁</span
                            ><span style="font-size: var(--text-sm); font-weight: 500">Reorder reminder: Emma W.</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="story" id="story">
        <div class="story-inner">
            ...
            <div class="story-pullquote reveal reveal-d1">
                I kept watching my wife drown in spreadsheets, texts, and sticky notes just to sell the bread people
                couldn't stop ordering.
            </div>
            <div class="story-divider reveal reveal-d2"></div>
            <div class="story-body">
                <p class="reveal reveal-d2">
                    She's the baker. He's the developer. Between managing orders through texts, tracking costs in a
                    notebook, and hoping the math worked out, they realized cottage food bakers deserved better tools.
                </p>
                <p class="reveal reveal-d3">
                    So they built one. Not another generic business app, but something made specifically for home bakers
                    who pour love into every recipe and deserve real tools to grow.
                </p>
    ...
    <section class="pricing" id="pricing">
        ...
        <div class="founding-callout reveal">
        ...
        <div class="contact-inner">
            <div class="contact-info">
                <div class="contact-header">
                    ...
                    <p class="reveal reveal-d1">
                        Have a question about KneadIt or wondering if it's the right fit for your bakery? We're a baker
                        and a developer who built this from our own kitchen table. Send us a message.
                    </p>
                </div>
    ...
    <section class="final-cta" id="cta">
        ...
        <div class="final-cta-content">
            <svg
                ...
                viewBox="0 0 60 80"
                fill="none"
                style="margin: 0 auto; display: block; opacity: 0.6"
            >
    ...
    <footer>
        ...
        <div style="font-size: var(--text-xs); color: var(--walnut); margin-top: 0.5rem">
