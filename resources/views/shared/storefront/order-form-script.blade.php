        ...
        return {
            ...
            get canSubmit() {
                return (
                    ...
                    (this.form.delivery_type === 'pickup' || (this.form.delivery_address && this.form.delivery_tier)) &&
            ...
            calculateSale() {
                this.saleDiscount =
                    this.sitewideSalePercent > 0 && this.subtotal > 0
            ...
            calculateTip() {
                if (this.tipMode === 'custom') {
                    ...
                    this.tipAmount =
                        this.subtotal > 0 ? Math.round(this.subtotal * (this.tipPercent / 100) * 100) / 100 : 0;
                }
            },
