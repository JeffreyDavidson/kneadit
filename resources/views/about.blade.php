...
<section class="relative overflow-hidden" style="min-height: 70vh;">
    <div class="absolute inset-0">
        <img src="{{ $heroImageUrl }}" alt="{{ $storeName }}" class="w-full h-full object-cover about-hero-img">
    </div>
    ...
    <div class="relative z-10 flex flex-col items-center justify-end text-center px-4 pb-20" style="min-height: 70vh;">
        ...
        @if($tagline)
        <p class="about-fade-2 font-script text-2xl md:text-3xl" style="color: var(--warm-400);">{{ $tagline }}</p>
        @endif
    </div>
</section>
