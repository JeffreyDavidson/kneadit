...
class WidgetMeta
{
    ...
    public static function all(): array
    {
        return self::$widgets ??= [
            ...
            'weekly_revenue' => new WidgetDefinition(class: WeeklyRevenueChartWidget::class, name: 'Weekly Revenue', description: 'This week\'s revenue breakdown', icon: Heroicon::OutlinedCurrencyDollar, defaultSize: WidgetSize::Medium, allowedSizes: [WidgetSize::Medium, WidgetSize::Large, WidgetSize::ExtraLarge], defaultHidden: true),
