...
final class PaymentsStep extends OnboardingStep
{
                ...
                Section::make('Payment Collection')
                    ...
                    ->schema([
                        ...
                        Section::make('Stripe Connection')
                            ...
                            ->visible(fn (Get $get) => in_array('stripe', $get('payments.payment_methods') ?? [])),
                        ...
                        Section::make('PayPal Connection')
                            ...
                            ->schema([
                                TextInput::make('payments.paypal_client_id')
                                    ...
                                    ->required(fn (Get $get) => in_array('paypal', $get('payments.payment_methods') ?? [])),
                            ...
                            ->visible(fn (Get $get) => in_array('paypal', $get('payments.payment_methods') ?? [])),
                    ])
                    ->footerActions([])
    ...
    {
        $methods = $data['payment_methods'] ?? ['cash'];
